...
DATABASE = {
    ...
    "Clothing, materials & cosplay": [
        ...
        ("socks", "specific"), ("sneakers/trainers", "specific"),
    ...
    "Humiliation, degradation & praise": [
        ...
        ("human ashtray/toilet (consensual)", "specific"),
    ],
    "Roleplay & scenarios": [
